...
const ThuChiScreen = () => {
    ...
    return (
        <View style={{ paddingHorizontal: 10 }}>
            ...
            <TextInput placeholder="Nhập ngày" value={date} onChangeText={setDate} />
            <TextInput placeholder="Nhập số tiền" value={amount} onChangeText={setAmount} inputMode="numeric" />
                            ...
                            (editId === row.id) ?
                                (
                                    <>
                                        ...
                                        <TextInput value={editDate} onChangeText={setEditDate} />
